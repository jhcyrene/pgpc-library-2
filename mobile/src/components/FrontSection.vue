      ...
      <div class="grid min-w-0 items-center gap-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] lg:gap-16 xl:gap-20">
        ...
        <div class="min-w-0 w-full max-w-2xl text-center lg:text-left">
          <div class="mb-5 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-white backdrop-blur-sm">
            <svg class="h-5 w-5 text-[#fcc719]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div class="mt-8 flex w-full flex-col items-stretch justify-center gap-3 sm:w-auto sm:flex-row sm:items-center lg:justify-start">
            <RouterLink
              to="/opac"
              class="inline-flex items-center justify-center gap-2 rounded-full bg-[#fcc719] px-6 py-3 font-bold text-[#102b70] shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#ffd84c]"
            >
            ...
            <RouterLink
              to="/login"
              class="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white/70 bg-white/10 px-6 py-3 font-bold text-white backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#fcc719] hover:bg-[#fcc719] hover:text-[#102b70]"
            >
              <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="divide-y divide-white/[0.06] px-5 sm:px-6">
              <div class="flex items-start gap-4 py-4">
                <span class="mt-0.5 grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-white/10 text-[#fcc719]">
                  <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 21-4.35-4.35m1.35-5.65a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" /></svg>
                </span>
                <div class="min-w-0">
