        ...
        <div class="flex flex-col sm:flex-row justify-between sm:items-start gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-[#102b70]">Book Details</h1>
                <p class="text-sm text-gray-500 mt-1">View comprehensive information about this title.</p>
            </div>
...
<div id="innerBarcodeModal" class="fixed inset-0 z-[60] hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 w-dvw overflow-y-auto">
