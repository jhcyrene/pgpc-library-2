...
<div id="books-table-container" class="bg-white border-x border-b border-gray-200 rounded-b-xl shadow-sm flex flex-col min-h-0 flex-1">
    <div class="responsive-table-scroll flex-1" tabindex="0" role="region" aria-label="Books table">
        <table class="responsive-table w-full min-w-[750px] text-left border-collapse">
            <thead
