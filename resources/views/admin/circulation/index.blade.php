<x-layout.admin>
    <div class="h-full flex flex-col bg-gray-50/50 p-4 md:p-6 lg:p-8">
        ...
        <!-- PAGE HEADER -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Circulation Desk</h1>
            <p class="text-sm md:text-base text-gray-500 mt-1">Manage book borrowing and returns.</p>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                ...
                <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4 transition-shadow hover:shadow-md">
                    ...
                    <div>
                        <p class="text-2xl font-black text-gray-900 leading-none" id="stat-checkouts">{{ $todaysCheckouts }}</p>
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mt-1">Today's Checkouts</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4 transition-shadow hover:shadow-md">
                    ...
                    <div>
                        <p class="text-2xl font-black text-gray-900 leading-none" id="stat-returns">{{ $todaysReturns }}</p>
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mt-1">Today's Returns</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4 transition-shadow hover:shadow-md">
                    ...
                    <div>
                        <p class="text-2xl font-black text-gray-900 leading-none" id="stat-overdue">{{ $overdueBooks }}</p>
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mt-1">Overdue Books</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4 transition-shadow hover:shadow-md">
                    ...
                    <div>
                        <p class="text-2xl font-black text-gray-900 leading-none" id="stat-fines">₱{{ number_format($outstandingFines, 2) }}</p>
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mt-1">Outstanding Fines</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-0">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full overflow-hidden relative">
                <!-- Section Header -->
                <div class="p-5 border-b border-gray-100 flex items-center gap-4 shrink-0 bg-blue-50/30">
