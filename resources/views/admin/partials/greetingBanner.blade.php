...
<div class="lg:col-span-2 bg-[#102b70] rounded-2xl p-6 md:p-8 relative overflow-hidden shadow-md hover:shadow-lg transition-shadow flex flex-col justify-between min-h-[220px] group">
