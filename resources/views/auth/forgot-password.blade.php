...
<head>
    ...
    <title>Forgot Password - Padre Garcia Polytechnic College Library</title>
    ...
    <div class="relative z-20 w-full max-w-md px-6 py-12 flex flex-col">
        ...
        <div class="bg-white rounded-3xl shadow-elegant p-8 md:p-10 transform transition-all">
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 text-center">
                <a href="/login" class="inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-primary transition-colors">
