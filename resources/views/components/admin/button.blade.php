...
@php
    ...
    $variants = [
        'primary' => 'bg-[#1A2B56] text-white hover:bg-[#101E3D] focus:ring-[#1A2B56]',
        'secondary' => 'bg-gray-100 text-gray-700 hover:bg-gray-200 focus:ring-gray-500',
        'outline' => 'border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-[#1A2B56]',
