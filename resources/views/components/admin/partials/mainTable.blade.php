                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-4">
                            <div
                                ...
                                {{ $book->edition ? substr($book->edition, 0, 4) : '' }}
                            </div>
                            <div>
                                <p class="text-sm font-bold text-gray-800">{{ $book->book_title }}</p>
                                <p class="text-xs text-gray-500 mt-0.5">ISBN: {{ $book->isbn }}</p>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 text-sm font-medium text-gray-700">{{ $book->author }}</td>
                    <td class="px-6 py-4">
                        <span
                            class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100">
                            {{ $book->category ? $book->category->category_name : 'Uncategorized' }}
                        </span>
                    </td>
                    <td class="px-6 py-4">
