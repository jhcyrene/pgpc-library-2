<div class="py-6 lg:py-10">
    ...
    @php
        $inputClass = 'h-13 w-full rounded-2xl border border-slate-200 bg-white px-4 text-slate-900 outline-none transition placeholder:text-slate-400 hover:border-slate-300 focus:border-[#102b70] focus:ring-4 focus:ring-blue-100';
        $labelClass = 'mb-2 block text-sm font-bold text-slate-700';
        $errorClass = 'mt-1.5 text-xs font-medium text-red-600';
    @endphp

    <form action="{{ route('register.store') }}" method="POST" class="space-y-7">
        @csrf
        ...
        <fieldset class="space-y-5">
            ...
            <div>
                ...
                @error('student_id_number') <p class="{{ $errorClass }}">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                ...
                @error('middle_name') <p class="{{ $errorClass }}">{{ $message }}</p> @enderror
            </div>
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                <div>
                    ...
                    @error('program') <p class="{{ $errorClass }}">{{ $message }}</p> @enderror
                </div>
                <div>
                    ...
                    @error('year_level') <p class="{{ $errorClass }}">{{ $message }}</p> @enderror
                </div>
            </div>
        </fieldset>
        ...
        <fieldset class="space-y-5">
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    @error('contact_num') <p class="{{ $errorClass }}">{{ $message }}</p> @enderror
                </div>
            </div>
        </fieldset>
