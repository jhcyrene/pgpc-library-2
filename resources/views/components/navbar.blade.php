...
<header id="main-header" class="fixed w-full z-50 transition-all duration-300 bg-transparent py-5">
    <div class="container mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-full bg-white flex items-center justify-center overflow-hidden shadow-sm">
                <img src="/images/pgpc-logo.jpg" alt="PGPC Logo" class="w-full h-full object-cover"
        ...
        <nav class="hidden md:flex items-center gap-8">
            ...
            <div class="flex items-center gap-2">
                <a href="/student/login" class="btn btn-login">
                    Log in
                </a>
                <a href="/student/register" class="btn btn-login">
                    Register
                </a>
            </div>
        </nav>
    ...
    <div id="mobile-menu"
        ...
        <a href="/opac"
            class="text-gray-300 hover:text-gold font-medium py-2 border-b border-white/10 transition-colors">OPAC</a>
        <a href="/#categories"
        ...
        <div class="flex gap-3 mt-2">
            <a href="/student/login" class="btn btn-login flex-1 py-3">
                Log in
            </a>
            <a href="/student/register" class="btn btn-login flex-1 py-3">
                Register
            </a>
        </div>
    </div>
