<x-layout.welcome title="Online Public Access Catalog | PGPC Library System" active="opac">
    ...
    <section class="relative overflow-hidden bg-[#102b70] pb-14 pt-28 text-white sm:pb-16 sm:pt-32">
        <div class="absolute inset-0 bg-cover bg-center opacity-10"
            style="background-image: url('{{ Vite::asset('resources/images/webp/pgpc-ng.webp') }}')" aria-hidden="true">
        </div>
        <div class="absolute inset-0 bg-gradient-to-b from-[#071943]/90 via-[#102b70]/90 to-[#102b70]" aria-hidden="true"></div>
        ...
        <div class="container relative z-10 mx-auto px-5 sm:px-6 md:px-12">
            <div class="mx-auto max-w-4xl text-center space-y-4">
                <p class="text-xs font-black uppercase tracking-[0.2em] text-[#fcc719]">PGPC LIBRARY SYSTEM</p>
                    ...
                    <div class="flex min-w-0 flex-col gap-2 rounded-2xl bg-white p-2 shadow-xl sm:flex-row sm:items-center sm:rounded-full">
                        <div class="flex min-w-0 flex-1 items-center gap-3 px-4">
                            ...
                            <input id="catalog-search" name="q" type="search" value="{{ $search }}"
                                ...
                                class="w-full border-0 bg-transparent py-2.5 text-sm text-slate-900 placeholder:text-slate-400 outline-none">
                        </div>
                        <button type="submit"
                            class="px-6 py-3 rounded-xl sm:rounded-full bg-[#fcc719] hover:bg-[#ffd84c] text-[#102b70] font-black text-xs uppercase tracking-wider transition-all shadow-sm shrink-0">
                            Search Catalog
                        </button>
                    </div>
                </form>
                ...
                <div class="flex flex-wrap items-center justify-center gap-4 text-xs font-semibold text-blue-100/80 pt-2">
                    @guest('member')
                        <p>
                            ...
                            <a href="{{ route('login') }}" class="font-bold text-[#fcc719] hover:underline">Student Login</a>
                        </p>
                    ...
                    <p>
                        ...
                        <a href="{{ route('opac.search') }}" class="font-bold text-[#fcc719] hover:underline">Advanced Search</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <dialog id="opac-book-detail-modal" class="modal modal-bottom p-0 sm:modal-middle sm:p-4" aria-labelledby="opac-book-detail-title">
        <div class="modal-box relative max-h-[94dvh] w-full max-w-none overflow-y-auto rounded-t-2xl bg-white p-0 shadow-2xl sm:w-[min(92vw,52rem)] sm:max-w-[52rem] sm:rounded-2xl border border-slate-200">
            <div class="sticky top-0 z-20 overflow-hidden bg-[#102b70] text-white">
                <div class="absolute inset-x-0 bottom-0 h-px bg-[#fcc719]"></div>
                <div class="flex items-center justify-between gap-4 px-5 py-4 sm:px-7 sm:py-5">
                    <div class="min-w-0">
                        <p class="text-[10px] font-extrabold uppercase tracking-[0.2em] text-[#fcc719]">Book Details</p>
