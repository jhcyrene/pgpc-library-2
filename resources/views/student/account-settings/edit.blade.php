...
<x-layout.student title="Account & Security">
    ...
    <dialog id="changePasswordModal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box w-[calc(100%-1rem)] max-w-md bg-white p-6 rounded-2xl relative shadow-xl border border-slate-100">
            ...
            <h3 class="font-extrabold text-lg text-slate-900 mb-1">Change Password</h3>
            <p class="text-xs text-slate-500 mb-5">Update your password to keep your account secure.</p>
            ...
            <form id="change-password-form" action="{{ route('student.account-settings.password') }}" method="POST" class="space-y-4">
                ...
                <div class="pt-2 flex gap-3">
                    ...
                    <button type="submit" id="btn-save-password" class="w-1/2 py-2.5 bg-[#102b70] hover:bg-[#0b225e] text-white font-bold text-xs rounded-xl transition-all shadow-sm">Update Password</button>
                </div>
            </form>
        </div>
