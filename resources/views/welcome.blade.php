...
<body class="antialiased font-sans bg-base-100 text-base-content min-h-screen flex flex-col">
    ...
    <section class="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        <!-- Background Image -->
        {{-- <div class="absolute inset-0 z-0 bg-cover bg-center bg-fixed" style="background-image: url('{{ Vite::asset('resources/images/school-img.jpg') }}')"></div> --}}
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                ...
                <a href="#" class="group bg-white p-6 rounded-2xl shadow-sm hover:shadow-elegant border border-gray-100 flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-2 hover:border-primaryfade/30">
                    <div class="group-hover:scale-110 transition-transform duration-300 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primaryfade" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>
                    </div>
                ...
                <a href="#" class="group bg-white p-6 rounded-2xl shadow-sm hover:shadow-elegant border border-gray-100 flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-2 hover:border-accent/30">
                    <div class="group-hover:scale-110 transition-transform duration-300 mb-4 text-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primaryfade" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    </div>
                ...
                <a href="#" class="group bg-white p-6 rounded-2xl shadow-sm hover:shadow-elegant border border-gray-100 flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-2 hover:border-accent/30">
                    <div class="group-hover:scale-110 transition-transform duration-300 mb-4 text-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primaryfade" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                    </div>
    ...
    <!-- About Section -->
    <section id="about" class="py-24 bg-primaryfade text-white relative overflow-hidden">
